...
from .Utility import isGui
from sklearn.preprocessing import StandardScaler
from scipy.signal import argrelextrema
from scipy.stats import linregress
from .ColorText import colorText
from .SuppressOutput import SuppressOutput
from .ScreenipyTA import ScreenerTA
try:
    import chromadb
...
class tools:
    ...
    def addVector(self, data, stockCode, daysToLookback):
        ...
        if len(data) == (4 * daysToLookback):
            chroma_client = chromadb.PersistentClient(path="unisonapp/chromadb_store/")
